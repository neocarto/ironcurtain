...
Nous utilisons pour celà les packages *eurostat* [@eurostat], *RnaturalEarth* [@rnaturalearth], *sf* [@sf] et *cartography* [@cartography1], [@cartography2].
...
Elimination des territoires hors de l'espace d'étude (re.g. remote territories)
